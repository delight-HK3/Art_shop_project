...
<html>
	...
	<script language = "javascript">
		...
		<main class="form-signin">
			<div class="card align-middle" style="width:50rem; height:75rem; border-radius:30px;">
				...
				<div class="card-body">
					...
					<!-- form2 시작 -->
						...
						<form name="form2" method="post" action="member_update.php" >
							...
							<div class="form-inline">
								<div style="width: 100px;">
									<label><h5 style="margin-bottom:15px">새비밀번호</h5></label>
								</div>
								<div style="margin-right:10px">
							...
							<div class="form-inline">
								<div style="width: 100px">
									<label><h5 style="margin-bottom:30px">새비밀번호 확인</h5></label>
								</div>
								<div style="margin-right:10px">
