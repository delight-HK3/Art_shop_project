...
<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
	...
	<tr> 
		...
		<td width="700" bgcolor="#F2F2F2">
			...
			?>
			<input type="text" name="regday1" value="<?=substr($today,0,4)?>" size="4" maxlength="4"> 년 &nbsp
			<input type="text" name="regday2" value="<?=substr($today,5,2)?>" size="2" maxlength="2"> 월 &nbsp
			<input type="text" name="regday3" value="<?=substr($today,8,2)?>" size="2" maxlength="2"> 일
		</td>
	</tr>
	<tr> 
