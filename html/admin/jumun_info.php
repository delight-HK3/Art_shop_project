	...
	<body style="margin:0">
		<center>
			...
			<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
				...
				<td width="300" height="20" bgcolor="#EEEEEE">&nbsp;<font size="3"><b><?php echo $row[no11]?> (<font color="blue"><?php echo $state?></font>)</b></font></td>
				<td width="100" height="20" bgcolor="#CCCCCC" align="center"><font color="#142712">주문일</font></td>
				<td width="300" height="20" bgcolor="#EEEEEE"><?php echo $row[jumunday11]?></td>
				</tr>
			</table>
			<br>
			<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
				...
				<td width="300" height="20" bgcolor="#EEEEEE"><?php echo $row[o_name11]?> (<?php echo $member_no?>)</td>
				<td width="100" height="20" bgcolor="#CCCCCC" align="center"><font color="#142712">주문자전화</font></td>
				<td width="300" height="20" bgcolor="#EEEEEE"><?php echo $o_tel?></td>
				</tr>
				<tr> 
				<td width="100" height="20" bgcolor="#CCCCCC" align="center"><font color="#142712">주문자 E-Mail</font></td>
				<td width="300" height="20" bgcolor="#EEEEEE"><?php echo $row[o_email11]?></td>
				<td width="100" height="20" bgcolor="#CCCCCC" align="center"><font color="#142712">주문자핸드폰</font></td>
				<td width="300" height="20" bgcolor="#EEEEEE"><?php echo $o_phone?></td>
				</tr>
				<tr> 
				<td width="100" height="20" bgcolor="#CCCCCC" align="center"><font color="#142712">주문자주소</font></td>
				<td width="300" height="20" bgcolor="#EEEEEE" colspan="3">(<?php echo $row[o_zip11]?>) <?php echo $row[o_juso11]?></td>
				</tr>
				</tr>
			</table>
			...
			<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
				...
				<td width="300" height="50" bgcolor="#EEEEEE" colspan="3"><?php echo $row[memo11]?></td>
				</tr>
			</table>
			<br>
			<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
			...
			<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
				<tr> 
				  <td width="100" height="20" bgcolor="#CCCCCC" align="center"><font color="#142712">총금액</font></td>
					<td width="700" height="20" bgcolor="#EEEEEE" align="right"><font color="#142712" size="3"><b><?php echo $Lasttotal?></b></font> 원&nbsp;&nbsp</td>
				</tr>
			</table>
