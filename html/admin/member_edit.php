...
<table width="600" border="1" cellpadding="2"  style="border-collapse:collapse">
	...
	<tr height="20"> 
		...
		<td width="500" bgcolor="#F2F2F2">
			<input type="text" name="pwd" value="<?=$row[pwd11]?>" size="20" maxlength="20">
		</td>
	</tr>
	<tr height="20"> 
		<td width="100" align="center" bgcolor="#CCCCCC">이름</td>
		<td width="500" bgcolor="#F2F2F2">
			<input type="text" name="name" value="<?=$row[name11]?>" size="20" maxlength="20">
		</td>
	</tr>
	<tr height="20"> 
		<td width="100" align="center" bgcolor="#CCCCCC">생일</td>
		<td width="500" bgcolor="#F2F2F2">
		 <input type="text" name="birthday1" size="4" maxlength="4" value="<?=substr($row[birthday11],0,4)?>"> -
		 <input type="text" name="birthday2" size="2" maxlength="2" value="<?=substr($row[birthday11],5,2)?>"> -
		 <input type="text" name="birthday3" size="2" maxlength="2" value="<?=substr($row[birthday11],8,2)?>"> </font>
			&nbsp;&nbsp 
			<?
				if($row[sm11]==0){
	...
	<tr height="20"> 
		...
		<td width="500" bgcolor="#F2F2F2">
			<input type="text" name="tel1" size="3" maxlength="3" value="<?=substr($row[tel11],0,3)?>"> -
			<input type="text" name="tel2" size="4" maxlength="4" value="<?=substr($row[tel11],3,4)?>"> -
			<input type="text" name="tel3" size="4" maxlength="4" value="<?=substr($row[tel11],7,4)?>">
		</td>
	</tr>
	<tr height="20"> 
		<td width="100" align="center" bgcolor="#CCCCCC">핸드폰</td>
		<td width="500" bgcolor="#F2F2F2">
			<input type="text" name="phone1" size="3" maxlength="3" value="<?=substr($row[phone11],0,3)?>"> -
			<input type="text" name="phone2" size="4" maxlength="4" value="<?=substr($row[phone11],3,4)?>"> -
			<input type="text" name="phone3" size="4" maxlength="4" value="<?=substr($row[phone11],7,4)?>">
		</td>
	</tr>
	<tr height="20"> 
		<td width="100" align="center" bgcolor="#CCCCCC">E-Mail</td>
		<td width="500" bgcolor="#F2F2F2">
			<input type="text" name="email" value="<?=$row[email11]?>" size="40" maxlength="40">
		</td>
	</tr>
	<tr height="20"> 
		<td width="100" align="center" bgcolor="#CCCCCC">주소</td>
		<td width="500" bgcolor="#F2F2F2">
			<input type="text" name="zip" value="<?=$row[zip11]?>" size="5" maxlength="5"> &nbsp 
			<input type="button" value="우편번호 찾기" onClick="javascript:OpenWinZip(0);"> <br>
			<input type="text" name="juso" value="<?=$row[juso11]?>" size="60" maxlength="100">
		</td>
	</tr>
	<tr height="20"> 
