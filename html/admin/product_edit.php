...
<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
	...
	<tr height="23"> 
		...
		<td width="700"  bgcolor="#F2F2F2">
			<input type="text" name="code" value="<?=$row[code11]?>" size="20" maxlength="20">
		</td>
	</tr>
	<tr> 
		<td width="100" bgcolor="#CCCCCC" align="center">상품명</td>
		<td width="700"  bgcolor="#F2F2F2">
			<input type="text" name="name" value="<?=$row[name11]?>" size="60" maxlength="60">
		</td>
	</tr>
	<tr> 
		<td width="100" bgcolor="#CCCCCC" align="center">제조사</td>
		<td width="700"  bgcolor="#F2F2F2">
			<input type="text" name="coname" value="<?=$row[coname11]?>" size="30" maxlength="30">
		</td>
	</tr>
	<tr> 
		<td width="100" bgcolor="#CCCCCC" align="center">판매가</td>
		<td width="700"  bgcolor="#F2F2F2">
			<input type="text" name="price" value="<?=$row[price11]?>" size="12" maxlength="12"> 원
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td width="700"  bgcolor="#F2F2F2">
			<textarea name="contents" rows="4" cols="70"><?=$row[contents11]?></textarea>
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td width="700"  bgcolor="#F2F2F2">
			...
			?>
			<input type="text" name="regday1" value="<?=substr($row[regday11],0,4)?>" size="4" maxlength="4"> 년 &nbsp
			<input type="text" name="regday2" value="<?=substr($row[regday11],5,2)?>" size="2" maxlength="2"> 월 &nbsp
			<input type="text" name="regday3" value="<?=substr($row[regday11],8,2)?>" size="2" maxlength="2"> 일 &nbsp
		</td>
	</tr>
	<tr> 
				...
				<tr>
					<td>
						<table width="390" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<input type='hidden' name='imagename1' value='<?=$row[image1_11]?>'>
									&nbsp;<input type="checkbox" name="checkno1" value="1"> <b>이미지1</b>: <?=$row[image1_11]?>
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<tr>
								<td>
									<input type='hidden' name='imagename2' value='<?=$row[image2_11]?>'>
									&nbsp;<input type="checkbox" name="checkno2" value="1"> <b>이미지2</b>: <?=$row[image2_11]?>
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<tr>
								<td>
									<input type='hidden' name='imagename3' value='<?=$row[image3_11]?>'>
									&nbsp;<input type="checkbox" name="checkno3" value="1"> <b>이미지3</b>: <?=$row[image3_11]?>
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<table width="390" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td  valign="middle">&nbsp;
									<img src="../product/<?=$row[image1_11]?>" width="50" height="50" border="1" style='cursor:hand' onclick="imageView('../product/<?=$row[image1_11]?>')">&nbsp;
									<img src="../product/<?=$row[image2_11]?>" width="50" height="50" border="1" style='cursor:hand' onclick="imageView('../product/<?=$row[image2_11]?>')">&nbsp;
									<img src="../product/<?=$row[image3_11]?>"  width="50" height="50" border="1" style='cursor:hand' onclick="imageView('../product/<?=$row[image3_11]?>')">&nbsp;
								</td>
							</tr>				 
						</table>
					</td>
					<td>
						<td align="right" width="310"><img name="big" src="../product/<?=$row[image1_11]?>" width="300" height="300" border="1"></td>
					</td>
				</tr>
			</table>
