	...
	<head>
		...
		<script language = "javascript">
			function check_id()	{
				...
				window.open("member_showid.php?name="+form2.name.value+"&email="+form2.email.value,"","scrollbars=no,width=300,height=200");
				form2.name.value="";
				form2.email.value="";
			}
		</script>
			...
			<form name="form2" method="post" action="">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class=" col-sm-6">
							<div>
								<input type="button" class="btn btn-lg btn-success btn-block" type="submit" value="ID 찾기" onClick="location.href='javascript:check_id();'">
							</div>
						</div>
					</div>
				</div>
