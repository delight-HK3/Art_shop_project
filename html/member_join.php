						...
						<input type="hidden" name="check_id"  value=""> 
							<div class="form-inline">
								...
								<div style="margin-right:10px">
									<input type="text" style="width: 20rem" class="form-control" placeholder="아이디" name="uid" maxlength = "12" value=""> 
								</div>
								<div>
									<input type="button" class="btn btn-lg btn-primary" type="submit" value="중복확인" onClick="search_id();">
								</div>
							</div>
							<p></p>
							<div class="form-inline">
								...
								<div style="margin-right:10px">
									<input type="password" style="width: 29rem" class="form-control" placeholder="비밀번호 입력" name="pwd" maxlength = "15" value=""> 
								</div>
							</div>
							<p></p>
							<div class="form-inline">
							...
							<div class="form-inline">
								...
								<div style="margin-right:10px">
									<input type="text" style="width: 20rem" class="form-control" placeholder="이름" name="name" maxlength = "10" value=""> 
								</div>
							</div>
							<p></p>
							<div class="form-inline">
							...
							<div class="form-inline">
								...
								<h5 style="margin-right:10px; margin-top:5px; margin-bottom:0px">양력</h5>
								<label class="radio-inline">
									<input type="radio" name="sm" value="1">
								</label>
								<h5 style="margin-top:5px; margin-bottom:0px">음력</h5>
							</div>
							<p></p>
							<div class="form-inline">
								<div style="width: 100px">
					...
					<div class="panel-footer">   
						<div class="container">
							<div class="row">
								<div class=" col-sm-6">
									<div>
										<button class="btn btn-lg btn-primary btn-block" type="submit" onClick="javascript:form2.reset();">다시입력</button>
									</div>
								</div>
								<div class=" col-sm-6">
									<div>
